...
libroUno = Libro(titulo="Yo Robot", autor="Isaac Asimov", genero="Ciencia Ficcion", editorial="Gnome Press")
...
libroAEliminar = session.query(Libro).filter_by(titulo='Yo Robot').one()
